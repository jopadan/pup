                      ...
                      const char *must_ext)
{
  ...
  fprintf(stdout,
          "s_path(&path, \"%s\", SYS_PATH_DELIM), strcmp(path, \"%s\") == 0: ",
          pathnameext, must_path);
  ...
  fprintf(stdout,
          "s_pathname(&pathname, \"%s\", SYS_PATH_DELIM), strcmp(pathname, \"%s\") == 0: ",
          pathnameext, must_pathname);
  ...
  fprintf(stdout,
          "s_name(&name, \"%s\", SYS_PATH_DELIM), strcmp(name, \"%s\") == 0: ",
          pathnameext, must_name);
  ...
  fprintf(stdout,
          "s_nameext(&name, \"%s\", SYS_PATH_DELIM), strcmp(nameext, \"%s\") == 0: ",
          pathnameext, must_nameext);
  ...
  fprintf(stdout,
          "s_ext(&ext, \"%s\", SYS_PATH_DELIM), strcmp(ext, \"%s\") == 0: ",
          pathnameext, must_ext);
...
int main(int argc, char *argv[])
{
  ...
  fprintf(stdout,
          "s_strcpy(&s, \"abcdefghij klmnop\"), s_strcpy(&s, s), strcmp(s, \"abcdefghij klmnop\") == 0: ");
  ...
  fprintf(stdout,
          "s_strcat(&s, s), strcmp(s, \"abcdefghijabcdefghij\") == 0: ");
  s_strcat(&s, s);
  ...
  fprintf(stdout,
          "s_strncat(&s, s, 10), strcmp(s, \"abcdefghijabcdefghijabcdefghij\") == 0: ");
  s_strncat(&s, s, 10);
  ...
  fprintf(stdout,
          "s_strcpy(&s, \"/path/name.ext\"), s_path(&s, s, SYS_PATH_DELIM), strcmp(s, \"/path/\") == 0: ");
  if (strcmp(s, "/path/") == 0)
    fprintf(stdout, "OK\n");
  else
  {
  ...
  fprintf(stdout,
          "s_strcpy(&s, \"/path/name.ext\"), s_pathname(&s, s, SYS_PATH_DELIM), strcmp(s, \"/path/name\") == 0: ");
  ...
  fprintf(stdout,
          "s_strcpy(&s, \"/path/name.ext\"), s_name(&s, s, SYS_PATH_DELIM), strcmp(s, \"name\") == 0: ");
  if (strcmp(s, "name") == 0)
    fprintf(stdout, "OK\n");
  else
  {
  ...
  fprintf(stdout,
          "s_strcpy(&s, \"/path/name.ext\"), s_nameext(&s, s, SYS_PATH_DELIM), strcmp(s, \"name.ext\") == 0: ");
  ...
  fprintf(stdout,
          "s_strcpy(&s, \"/path/name.ext\"), s_ext(&s, s, SYS_PATH_DELIM), strcmp(s, \".ext\") == 0: ");
  if (strcmp(s, ".ext") == 0)
    fprintf(stdout, "OK\n");
  else
  {
  ...
  i +=
    check_pathnameext("path/name.ext", "path/", "path/name", "name", "name.ext",
                      ".ext");
  i += check_pathnameext("path.e/", "path.e/", "path.e/", "", "", "");
  i +=
    check_pathnameext("path.e/name", "path.e/", "path.e/name", "name", "name",
                      "");
  i +=
    check_pathnameext("path.e/.ext", "path.e/", "path.e/", "", ".ext", ".ext");
  i +=
    check_pathnameext("path.e/name.ext", "path.e/", "path.e/name", "name",
                      "name.ext", ".ext");
