...
bool_t dat2_extract_resource(restable_t * rt, size_t i)
{
  char *filename;
...
bool_t dat2_add_resource(restable_t * rt, size_t i)
{
  char *filename;
  ...
  {
    fprintf(stderr, "dat2_add_resource: Can't add entry #%zu.\n", i);
    s_free(&filename);
    return FALSE;
  }
